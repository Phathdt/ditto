...
const (
	// BeginMsgType common begin message type.
	BeginMsgType byte = 'B'

	// CommitMsgType common commit message type.
	CommitMsgType byte = 'C'

	// DeleteMsgType common delete message type.
	DeleteMsgType byte = 'D'

	// InsertMsgType common insert message type.
	InsertMsgType byte = 'I'

	// NewTupleDataType common new tuple data type.
	NewTupleDataType byte = 'N'

	// OriginMsgType common original message type.
	OriginMsgType byte = 'O'

	// RelationMsgType common relation message type.
	RelationMsgType byte = 'R'

	// UpdateMsgType common update message type.
	...
	// TextDataType common test data type.
	TextDataType byte = 't'

	// ToastDataType common toast data type.
